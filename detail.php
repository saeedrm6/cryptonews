            ...
            <div class="jeg_nav_row">
                <div class="col-md-9 col-xs-0 hidden-xs">
                    <div class="col-md-3">
                        ...
                        <span>
                            <span id="BTCprice"></span><span class="pull-left">تومان</span>
                        </span><br>
                    ...
                    <div class="col-md-3">
                        ...
                        <span>
                            <span id="ETHprice"></span><span class="pull-left">تومان</span>
                        </span><br>
                    ...
                    <div class="col-md-3">
                        ...
                        <span>
                            <span id="LTCprice"></span><span class="pull-left">تومان</span>
                        </span><br>
                    ...
                    <div class="col-md-3">
                        ...
                        <span>
                            <span id="XRPprice"></span><span class="pull-left">تومان</span>
                        </span><br>
...
//                console.log(format(data.RAW.BTC.USD.PRICE*6900,"تومان").replace(".0",""));
                document.getElementById("BTCprice").innerHTML = format(data.RAW.BTC.USD.PRICE*6900,"").replace(".0","");
    ...
    window.setInterval(function(){
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                document.getElementById("ETHprice").innerHTML = format(data.RAW.ETH.USD.PRICE*6900,"").replace(".0","");
                ...
                document.getElementById("LTCprice").innerHTML = format(data.RAW.LTC.USD.PRICE*6900,"").replace(".0","");
                ...
                document.getElementById("XRPprice").innerHTML = format(data.RAW.XRP.USD.PRICE*6900,"").replace(".0","");
